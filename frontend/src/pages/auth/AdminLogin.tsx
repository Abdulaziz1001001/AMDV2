    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-sunken">
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-accent-soft mx-auto mb-4">
            <Shield className="h-6 w-6 text-accent" />
          </div>
          <h1 className="text-xl font-bold tracking-tight text-text-primary">{t('adminLogin')}</h1>
        </div>
