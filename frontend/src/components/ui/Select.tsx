...
/**
 * Native `<select>`: closed state follows theme via `bg-surface` / `text-foreground`.
 * The OS-rendered dropdown list cannot be fully styled with CSS; `html { color-scheme }` in app.css helps.
 * For pixel-perfect themed dropdowns, use `@radix-ui/react-select` instead.
 */
